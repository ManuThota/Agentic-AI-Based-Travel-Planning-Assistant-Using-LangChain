...
Vagabond AI is an intelligent, autonomous travel planner built using Python, LangChain, and Streamlit. It leverages an Agentic AI workflow to design personalized multi-day itineraries, recommending optimal flights, hotels, and attractions from structured datasets, fetching real-time weather forecasts, and providing interactive budget breakdowns.

---

## 🌟 Key Features

1. **Dual AI Provider Support:** Support for both **Google Gemini** developer APIs and **Groq AI** models.
...
3. **5 Specialized Data Tools:**
   * **Flight Finder:** Filters flights by origin/destination and cabin class, sorting by price or duration.
   * **Hotel Selector:** Recommends hotel accommodations based on destination, pricing, ratings, and amenities.
   * **Attraction Explorer:** Suggests point-of-interest (POI) sights grouped by theme (Beach, Heritage, Nature, Adventure).
...
GROQ_API_KEY=gsk_...
```
*Note: You can also enter either API key directly within the app sidebar at runtime.*
...
Inside the sidebar, choose between **Google Gemini** and **Groq AI** under **Select LLM Provider** to switch engine APIs instantly!
